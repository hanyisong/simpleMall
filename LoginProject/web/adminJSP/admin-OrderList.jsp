...
<script type="text/javascript">
                ...
                if (data) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        str += "<tr><td>"
                            ...
                            + "</td><td>"
                            + list[i].state//订单状态
                            + "</td><td><a style='cursor:pointer;border: #5a6268;' class='btn' onclick = 'UpdateOrder("
                            + list[i].order_id
                            + ")'>发货</a></td></tr>";
                    }
                    $("#table").append(str);
    ...
    function UpdateOrder(order_id) {
        $.ajax({
            ...
            success: function (data) {
                    alert(data.msg);
                    window.location.href = "admin-OrderList.jsp";//重新执行自动查询
            },
            error: function () {
                alert("后台中断！");
            }
